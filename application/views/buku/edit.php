        ...
        <div class="card">
            ...
            <?php foreach ($books as $rows) : ?>
                <form action="" method="post">
                    <input type="hidden" name="slug" value="<?= $rows->id; ?>">
                    ...
                    <div class="form-group">
                        <label for="first_sentence">First_sentence</label>
                        <input type="text" name="first_sentence" class="form-control" id="first_sentence" value="<?= $rows->first_sentence; ?>">
                        <small class="form-text text-danger"><?= form_error('first_sentence'); ?></small>
                    </div>
                    <div class="form-group">
                        <label for="published">Published</label>
                        <input type="text" name="published" class="form-control" id="published" value="<?= $rows->published; ?>">
